...
# (TJH2006/2/10): I'm guessing the above is some kind of pseudo code shorthand
# for making these other Error classes from PubError?
...
# Parsing Errors that I have mentioned in the documentation (TJH 2006-2/13)

class ParseError(PubError):
    """
    Some problem was encountered during parsing of a command.
    """
    pass

class LexicalParseError(ParseError):
    """
    Could not read one or more words, or words unknown.
    """
    pass

class SyntaxParseError(ParseError):
    """
    Words okay, but syntax bad.  Ill-formed or syntactically-ambiguous sentence.
    """
    pass

class SemanticParseError(ParseError):
    """
    Sentence legal, but unable to de-reference phrases to PUB objects.
    """
    pass

class AmbiguousSemanticsError(ParseError):
    """
    Legal sentence, but more than one possible de-referencing -- semantically ambiguous.
    """
    pass

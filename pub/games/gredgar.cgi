...
#                  adapted for CGI       2004-06-11 Clint McCulloch
...
pub.player = pub.pubcgi.CGIPlayer('Fred') 
...
# with custom headers and footers, e.g.:
#pub.pubcgi.handle_request('saves',
#    header = open('header.html', 'r').read(), 
#    footer = open('footer.html', 'r').read()
#    )

# first argument is a readable/writable directory for saves
pub.pubcgi.handle_request('saves', title='The Greedy Gargoyle')
